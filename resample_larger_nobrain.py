"""
Expand bounding box from size = 144 x 144 x 144 to size = 192 x 192 x 192.
"""
...
# Default paths
path_in = '/data/pg-umcg_mii/data/hecktor2022/imagesTr_PT_nobrain/'
path_label_in = '/data/pg-umcg_mii/data/hecktor2022/labelsTr/'
path_out = '/data/pg-umcg_mii/data/hecktor2022/resampled_larger/'
path_bb = '/data/pg-umcg_mii/data/hecktor2022/src/bb_box/bb_box_training.csv'
...
def main(input_folder, input_label_folder, output_folder, bounding_boxes_file, cores, resampling):
    ...
    def resample_one_patient(p):
        ...
        pt = sitk.ReadImage(
            str([f for f in input_folder.rglob(p + "__PT_nobrain*")][0].resolve()))
        ...
        sitk.WriteImage(pt, str(
            (output_folder / (p + "__PT_nobrain.nii.gz")).resolve()))
